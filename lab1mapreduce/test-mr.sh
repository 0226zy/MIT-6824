...
# generate the correct output
../cmd/mrsequential ../mrapps/indexer.so ../data/pg*txt || exit 1
...
# start multiple workers
$TIMEOUT ../cmd/mrworker ../mrapps/indexer.so &
$TIMEOUT ../cmd/mrworker ../mrapps/indexer.so
...
$TIMEOUT ../cmd/mrworker ../mrapps/jobcount.so &
$TIMEOUT ../cmd/mrworker ../mrapps/jobcount.so
$TIMEOUT ../cmd/mrworker ../mrapps/jobcount.so &
$TIMEOUT ../cmd/mrworker ../mrapps/jobcount.so
...
($TIMEOUT ../cmd/mrcoordinator ../data/pg*txt ; touch $DF) &

# give the coordinator time to create the sockets.
sleep 1

# start multiple workers.
($TIMEOUT ../cmd/mrworker ../mrapps/early_exit.so ; touch $DF) &
($TIMEOUT ../cmd/mrworker ../mrapps/early_exit.so ; touch $DF) &
($TIMEOUT ../cmd/mrworker ../mrapps/early_exit.so ; touch $DF) &
